// TugasPertemuanKetiga.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
	...
	display(); //memanggil prosuder untuk menampilkan data yang telah urut
	system("pause");
